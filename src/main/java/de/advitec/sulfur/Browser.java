...
public class Browser {
    ...
    private static final String SCREENSHOT_DIR = "/tmp/fitnesse-screenshots";
    ...
    public Browser(String browserName) {
        if (browser == null) {
            ...
            browser.manage().timeouts().implicitlyWait(IMPLICITLY_WAIT_TIME, TimeUnit.SECONDS);
        }
    }
    ...
    /**
     * Checks whether the element doesn't exist.
     * Example: {@code | wait | X | seconds for element | id:someElement | with text | text | }
     * @param seconds
     * @param element
     * @param text
    public static void waitSecondsForElementWithText(int seconds, String element, String text) {
        browser.manage().timeouts().implicitlyWait(seconds, TimeUnit.SECONDS);
        elementHasText(element, text);
    }
     */

    /**
     * Checks whether the element doesn't exist.
     * Example: {@code | wait | X | seconds for element | id:someElement | }
     * @param seconds
     * @param element
     * @return true if element was found in given time, false if not
     */
    public static boolean waitSecondsForElement(int seconds, String element) {
        browser.manage().timeouts().implicitlyWait(seconds, TimeUnit.SECONDS);
        boolean ret = elementExists(element);
        browser.manage().timeouts().implicitlyWait(IMPLICITLY_WAIT_TIME, TimeUnit.SECONDS);
        return ret;
    }
